    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.status(200).json({
                    results: orders,
                    message: "".concat(orders.length, " order has been retrived succesfully"),
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                res.status(200).json({
                    results: order,
                    message: "order with id:".concat(id, " has been retrived succesfully"),
                });
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, createdOrder, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                order = {
            ...
            case 2:
                ...
                res.status(200).json({
                    ...
                    message: "New order with id:".concat(createdOrder.orderId, " has been created succesfully"),
                });
                return [3 /*break*/, 4];
            case 3:
                error_3 = _a.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, order, updatedOrder, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = +req.params.id;
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                res.status(200).json({
                    ...
                    message: "order with id:".concat(id, " has been removed succesfully"),
                });
                return [3 /*break*/, 4];
            case 3:
                error_5 = _a.sent();
