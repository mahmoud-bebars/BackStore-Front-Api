...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.create = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, orderId, result, order, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'INSERT INTO orders (userid,orderid,quantity,status) VALUES($1, $2, $3,$4) RETURNING *';
                        orderId = (0, uuid_1.v4)();
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, {
                                quantity: 0,
                                status: '',
                                msg: "Could not add order . Error: ".concat(err_1),
                            }];
    ...
    OrderStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, results, orders, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE orders SET status =($2),quantity=($3) WHERE id=($1) RETURNING *';
                        return [4 /*yield*/, conn.query(sql, [id, o.status, o.quantity])];
                    case 2:
                        result = _a.sent();
                        order = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update order with id: ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not delete order with id: ".concat(id, ". Error: ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
